...
def make_phone_call(
    recipient_phone, call_script, twilio_number, account_sid, auth_token
):
    """
    ...
    twiml_response.say(
        call_script, voice="alice"
    )  # 'alice' is a natural-sounding voice

    try:
        # Initiate the call
        call = client.calls.create(
            twiml=twiml_response.to_xml(), from_=twilio_number, to=recipient_phone
        )
